...
?>    
<form method="post" action="<?=base_url()?>Categories/add_categories" enctype="multipart/form-data" id="mainform">
           ...
           <tr>
             ...
             <td>
               <div class="settingsinf">
                 <input type="text" name="name" value="<?=set_value('name')?>" placeholder="Category Name" >
