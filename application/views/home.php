...
<ul id="demo1">
	<li>
		<img src="<?=base_url()?>asset/images/66.jpg" alt="" />
		<!--Slider Description example-->
		<div class="slide-desc">
			<h3 style="color:white;font-weight: 700;text-shadow: 1px 1px 3px black;background: rgba(0, 0, 0, 0.2);">buy our innovative Electronics products</h3>
		</div>
	</li>
	<li>
		<img src="<?=base_url()?>asset/images/55.jpg" alt="" />
		<div class="slide-desc">
			<h3 style="color:white;font-weight: 700;text-shadow: 1px 1px 3px black;background: rgba(0, 0, 0, 0.2);">all Products Are Now available on OnLine</h3>
		</div>
	</li>
