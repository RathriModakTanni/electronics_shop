 		...
 		<div class="container">
 			<div class="w3_footer_grids">
 				...
 				<div class="col-md-3 w3_footer_grid">
 					...
 					<ul class="info"> 
              <?php     
              $categories =  $this->db->select('*')->from('categories')->order_by('id','asc')->limit(4)->get()->result_array();
              ?>
              <?php foreach ($categories as $key => $categoriess) { ?>            
 						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="<?=base_url().'Products/index/'.$categoriess['id'];?>"><?php echo $categoriess['name']; ?></a></li>
            <?php } ?>
 					</ul>
 				</div>
 				<div class="col-md-3 w3_footer_grid">
